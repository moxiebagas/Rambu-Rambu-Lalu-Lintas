...
public class rpetunjuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rpetunjuk);
        ...
        kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intructionIntent = new Intent(rpetunjuk.this, menurambu.class);
        ...
        final MediaPlayer b1 = MediaPlayer.create(this, R.raw.wihara);
        final MediaPlayer b2 = MediaPlayer.create(this, R.raw.gereja);
        final MediaPlayer b3 = MediaPlayer.create(this, R.raw.masjid);
        final MediaPlayer b4 = MediaPlayer.create(this, R.raw.pura);
        final MediaPlayer b5 = MediaPlayer.create(this, R.raw.klinik);
        final MediaPlayer b6 = MediaPlayer.create(this, R.raw.rumah_sakit);
        final MediaPlayer b7 = MediaPlayer.create(this, R.raw.jalur_pejalan);
        final MediaPlayer b8 = MediaPlayer.create(this, R.raw.jalur_sepeda);
        final MediaPlayer b9 = MediaPlayer.create(this, R.raw.jalur_angkutan);
        ...
        ButtonSuara1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup1);
        ...
        ButtonSuara2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup2);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b2.start();
        ...
        ButtonSuara3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup3);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b3.start();
        ...
        ButtonSuara4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup4);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b4.start();
        ...
        ButtonSuara5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup5);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b5.start();
        ...
        ButtonSuara6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup6);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b6.start();
        ...
        ButtonSuara7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup7);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b7.start();
        ...
        ButtonSuara8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup8);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b8.start();
        ...
        ButtonSuara9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TampilGambar.setImageResource(R.drawable.petunjukpopup9);
                TampilGambar.setVisibility(view.VISIBLE);
                TampilGambar.startAnimation(animScale);
                mInvisible(view);
                b9.start();
